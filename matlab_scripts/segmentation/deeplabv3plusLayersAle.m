%Author : Daniela Cuza
function lgraph = deeplabv3plusLayersAle(imageSize, numClasses, network, varargin)
...
s.efficientnetb0 = struct(...
    'Name',"efficientnetb0",...
    'FeatureExtractionLayer', "efficientnet-b0|model|head|MulLayer", ...
    'LowLevelFeatureLayer', "efficientnet-b0|model|blocks_3|MulLayer",...
    'LastDownsamplingLayers',["efficientnet-b0|model|blocks_11|depthwise_conv2d|depthwise"],...
    'SecondLastDownsamplingLayers',[]);
