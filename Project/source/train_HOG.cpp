...
int main( int argc, char** argv )
{
    ...
    String neg_dir = "../Data/HOG-object-detection-master/hand-pos/";
    String test_dir = "../Data/HOG-object-detection-master/hand-pos/";
    String obj_det_filename = "my_hand_detector2.yml";
   // String videofilename = parser.get< String >( "tv" );
    int detector_width = 24;
    int detector_height = 24;
    ...
    svm->setCoef0( 0.0 );
    svm->setDegree( 3 );
    svm->setTermCriteria( TermCriteria(TermCriteria::EPS | TermCriteria::COUNT, 1000, 1e-3 ) );
    svm->setGamma( 0 );
